...
std::vector<Move> Board::get_free_move(Position position) const {
...
std::vector<Position> Board::get_enemy_neighbors(Position position) const {
...
std::vector<Position> Board::get_enemy_neighbors_of_king(
